...
[![Go Report Card](https://goreportcard.com/badge/github.com/momentodevs/Momento)](https://goreportcard.com/report/github.com/momentodevs/Momento)

A music bot written in go

# Features

- Supports what [yt-dlp](https://github.com/yt-dlp/yt-dlp) does, plus spotify playlists (if you configure the
  required tokens!)
- Uses slash commands (see [Commands](https://momentodevs.github.io/Momento/commands.html) for a list of commands)
